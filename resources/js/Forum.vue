<template>
    <div class="w-full h-full">
        <div class="bg-img">
            <div class="mt-28 md:mb-20 md:px-0 px-6 md:mr-0 mr-3">
                <ButtonComponent />
                <Suspense>
                    <template #default>
                        <div class="parent-grid grid lg:grid-cols-3 grid-cols-1 lg:gap-5">
                            <UserForumPost />
                            <div
                                class="rightContent rounded-t-md bg-white outline outline-1 outline-gray-300 mt-5 md:mb-0 mb-5 md:w-10/12 w-full h-fit md:p-2 p-5">
                                ...
                                <div v-for="user in users" :key="user.id"
                                    ...
                                    <div class="user-section flex items-center mt-2">
                                        <div class="img-user">
                                            <img v-if="user.photo_profile !== null" v-lazy="{ src: `/storage/${user.photo_profile}`, loading: 'https://i.postimg.cc/mk7RvYQk/home-forum.webp', error: 'https://i.postimg.cc/qvZq70jF/error-img-removebg-preview.webp'}"
                                                class="w-10 h-10 rounded mr-10" :alt="user.photo_profile">
                                            <img v-else-if="user.photo_profile_fb !== null" v-lazy="{ src: user.photo_profile_fb, loading: 'https://i.postimg.cc/mk7RvYQk/home-forum.webp', error: 'https://i.postimg.cc/qvZq70jF/error-img-removebg-preview.webp'}"
                                                class="w-10 h-10 rounded mr-10" :alt="user.photo_profile_fb">
                                            <img v-else :src="'/img/default-profile.webp'" class="w-10 h-10 rounded mr-10"
                                    ...
                                    <div
                                        class="last-login flex justify-end items-center space-x-3 text-center text-sm">
