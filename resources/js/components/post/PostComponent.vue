    ...
    <div class="w-full md:w-4/5 h-full mt-28 mb-10 shadow-md shadow-gray-400 bg-white rounded-md p-2">
        <div class="user-auth flex items-center justify-between mt-2">
            <div class="left-item flex items-center space-x-3">
                <!-- <img v-if="post.users.photo_profile !== null"
                    v-lazy="{ src: post.users.photo_profile, loading: 'https://i.postimg.cc/mk7RvYQk/home-forum.webp', error: 'https://i.postimg.cc/qvZq70jF/error-img-removebg-preview.webp'}"
                    class="w-12 h-12 rounded-full shadow-md shadow-gray-500" :alt="post.users.photo_profile">
                <img v-else
                    v-lazy="{ src: '/img/default-profile.webp', loading: 'https://i.postimg.cc/mk7RvYQk/home-forum.webp', error: 'https://i.postimg.cc/qvZq70jF/error-img-removebg-preview.webp'}"
                    alt="https://www.freepik.com/vectors/secret-agent"
                    class="w-12 h-12 rounded-full shadow-md shadow-gray-500"> -->
                <img v-if="post.users.photo_profile !== null"
        ...
        <div class="tags-section flex justify-center items-center space-x-3 mt-2">
            ...
            <div v-for="cat in post.categories" :key="cat.id"
                class="categories cursor-pointer flex items-center space-x-1 rounded bg-red-500 hover:bg-red-400 transition duration-300 text-white p-1 uppercase">
        ...
        <div class="description-section indent-4 px-5 space-y-3 leading-relaxed break-words" v-html="post.description">
        </div>
    </div>
</template>
